...
# 3. If there is a match, pick a random letter (letter_1.txt/letter_2.txt/letter_3.txt) from letter_templates
...
if (month, day) in birthdays_dict:
    name = birthdays_dict[(month, day)]['name']
    email = birthdays_dict[(month, day)]['email']
    file_name = f"letter_templates/letter_{random.randint(1,3)}.txt"
    with open(file_name) as birthday_letter:
